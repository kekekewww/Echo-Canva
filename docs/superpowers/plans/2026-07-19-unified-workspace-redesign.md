...
- [ ] **Step 3: Define authoring contracts and defaults**
...
- [ ] **Step 4: Implement immutable commands and invariants**
...
- [ ] **Step 5: Implement engine projections**
...
- [ ] **Step 1: Write failing cache and history tests**
...
- [ ] **Step 4: Implement bounded command history**
...
- [ ] **Step 5: Implement the project hook**
...
- [ ] **Step 1: Write failing numeric and workspace browser tests**
...
- [ ] **Step 3: Implement `NumericScrubField`**
...
- [ ] **Step 5: Connect existing viewports through adapters**
...
- [ ] **Step 1: Write failing listener and local-asset tests**
...
- [ ] **Step 3: Implement IndexedDB local audio**
...
- [ ] **Step 4: Add runtime asset resolution to `AudioEngine`**
...
- [ ] **Step 5: Implement Add and active-listener flows**
...
- [ ] **Step 1: Write failing geometry and disable tests**
...
- [ ] **Step 3: Implement pure constraints**
...
- [ ] **Step 4: Compile enabled finite geometry**
...
- [ ] **Step 5: Implement viewport authoring and Inspector fields**
...
- [ ] **Step 3: Expose complete path-display data**
...
- [ ] **Step 4: Render projected 3D overlays**
...
- [ ] **Step 5: Add compact controls and hint cards**
...
- [ ] **Step 1: Add accessibility and responsive acceptance tests**
...
- [ ] **Step 2: Add performance and persistence stress cases**
...
- [ ] **Step 3: Finish compact visual design**
